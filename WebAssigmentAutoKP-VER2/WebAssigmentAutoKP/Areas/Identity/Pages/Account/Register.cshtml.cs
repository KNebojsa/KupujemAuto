...
namespace WebAssigmentAutoKP.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(50, ErrorMessage = "Maksimalno50Karaktera")]
            [Display(Name = "Email")]
            [EmailAddress(ErrorMessage ="FormaMaila")]
            ...
            [Compare("Password", ErrorMessage = "RazliciteLozinke.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ApplicationUser { UserName = Input.UserName, Email = Input.Email, Ime=Input.Ime, Prezime=Input.Prezime };
